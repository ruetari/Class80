...
with open('/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA3/std1.pkl', 'rb') as f:
    genome = pickle.load(f)

config = neat.config.Config(neat.DefaultGenome, neat.DefaultReproduction,neat.DefaultSpeciesSet, neat.DefaultStagnation,'/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA3/config-feedforward.txt')  
...
background_image = pygame.image.load("/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA3/track2.png").convert()

player_image = pygame.image.load("/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA3/car.png").convert_alpha()
