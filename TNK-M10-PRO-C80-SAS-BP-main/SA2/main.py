...
with open('/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA2/std1.pkl', 'rb') as f:
   genome = pickle.load(f)

# Load the configuration file
config = neat.config.Config(neat.DefaultGenome, neat.DefaultReproduction,neat.DefaultSpeciesSet, neat.DefaultStagnation,'/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA2/config-feedforward.txt')  
...
background_image = pygame.image.load("/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA2/track.png").convert()
player_image = pygame.image.load("/Users/ruetari/Desktop/TNK-M10-PRO-C80-SAS-BP-main/SA2/car.png").convert_alpha()
